...
export const MobileNav = () => {
    return (
        <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 h-16 flex items-center justify-around z-50 px-4">
            ...
            <Link to="/dashboard/history" className="flex flex-col items-center gap-1 text-slate-400">
            ...
            <Link to="/dashboard/guardians" className="flex flex-col items-center gap-1 text-slate-400">
                <Users className="w-6 h-6" />
                <span className="text-[10px] font-bold">Guardians</span>
            </Link>
            <Link to="/dashboard/profile" className="flex flex-col items-center gap-1 text-slate-400">
