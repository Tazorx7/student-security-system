...
export const SettingsSidebar = () => {
    return (
        <aside className="w-full md:w-64 flex flex-col gap-2">
            ...
            <Link className="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all" to="#">
                <User className="w-5 h-5" />
                <span className="text-sm font-medium">Account Info</span>
            </Link>
            <Link className="flex items-center gap-3 px-4 py-3 rounded-lg bg-primary/10 text-primary border border-primary/20 transition-all" to="#">
